...
const expenseHistoryOverview = () => import('./views/expense-history-overview.vue');
...
const agronomicRoutes = [
    ...
    },
    {
        ...
        name: 'agronomic-expense-history',
        component: expenseHistoryOverview,
        meta: {
            title: 'Expense History',
            description: 'Track climate mitigation and phytosanitary intervention costs across your plots.'
        }
    }
];
